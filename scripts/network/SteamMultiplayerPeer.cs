...
public sealed partial class SteamMultiplayerPeer
{
    /// <summary>
    /// Reference to the Godot class in gdscript.
    /// </summary>
    public readonly MultiplayerPeerExtension _classReference;
    ...
    public SteamMultiplayerPeer()
    {
        ...
        _classReference = ClassDB.Instantiate(stringName).As<MultiplayerPeerExtension>();
    }

    public Error HostWithLobby(ulong lobby)
    {
        return _classReference.Call(Methods.HostWithLobby, lobby).As<Error>();
    }

    public Error ConnectToLobby(ulong lobby)
    {
        return _classReference.Call(Methods.ConnectToLobby, lobby).As<Error>();
    }
    ...
    public ulong GetSteam64FromPeerId(uint id)
    {
        return _classReference.Call(Methods.GetSteam64ForPeerId, id).AsUInt64();
    }

    public uint GetPeerIdFromSteam64(ulong id)
    {
        return _classReference.Call(Methods.GetPeerIdForSteam64, id).AsUInt32();
    }
    ...
    */
    ...
    {
        public static readonly StringName HostWithLobby = new("host_with_lobby");
        public static readonly StringName ConnectToLobby = new("connect_to_lobby");
        ...
        public static readonly StringName GetSteam64ForPeerId = new("get_steam_id_for_peer_id");
        public static readonly StringName GetPeerIdForSteam64 = new("get_peer_id_for_steam_id");
    }
}
