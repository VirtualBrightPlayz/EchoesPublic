...
public class JoltPhysicsDirectSpaceState3DExtension
{
	// Engine object used for calling engine methods
	protected PhysicsDirectSpaceState3DExtension _object;

	public JoltPhysicsDirectSpaceState3DExtension() : this(NativeName)
	{
	}
	protected JoltPhysicsDirectSpaceState3DExtension(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected JoltPhysicsDirectSpaceState3DExtension(Variant variant) : this((PhysicsDirectSpaceState3DExtension) variant)
	{
	}
	protected JoltPhysicsDirectSpaceState3DExtension([NotNull] PhysicsDirectSpaceState3DExtension @object)
	{
		_object = @object;
	}

	public static implicit operator PhysicsDirectSpaceState3DExtension(JoltPhysicsDirectSpaceState3DExtension self) => self?._object;
	public static implicit operator Variant(JoltPhysicsDirectSpaceState3DExtension self) => self?._object;
	public static explicit operator JoltPhysicsDirectSpaceState3DExtension(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : PhysicsDirectSpaceState3DExtension.PropertyName
	{

	}

	public class MethodName : PhysicsDirectSpaceState3DExtension.MethodName
	{

	}

	public class SignalName : PhysicsDirectSpaceState3DExtension.SignalName
	{

	}

	private static readonly StringName NativeName = "JoltPhysicsDirectSpaceState3DExtension";

	#region Inherited Methods

	public bool IsBodyExcludedFromQuery(Godot.Rid @body)
	{
		return _object.IsBodyExcludedFromQuery(@body);
	}

	public Godot.Collections.Array<Godot.Collections.Dictionary> IntersectPoint(PhysicsPointQueryParameters3D @parameters, int @max_results = 32)
	{
		return _object.IntersectPoint(@parameters, @max_results);
	}

	public Godot.Collections.Dictionary IntersectRay(PhysicsRayQueryParameters3D @parameters)
	{
		return _object.IntersectRay(@parameters);
	}

	public Godot.Collections.Array<Godot.Collections.Dictionary> IntersectShape(PhysicsShapeQueryParameters3D @parameters, int @max_results = 32)
	{
		return _object.IntersectShape(@parameters, @max_results);
	}

	public float[] CastMotion(PhysicsShapeQueryParameters3D @parameters)
	{
		return _object.CastMotion(@parameters);
	}

	public Godot.Collections.Array<Godot.Vector3> CollideShape(PhysicsShapeQueryParameters3D @parameters, int @max_results = 32)
	{
		return _object.CollideShape(@parameters, @max_results);
	}

	public Godot.Collections.Dictionary GetRestInfo(PhysicsShapeQueryParameters3D @parameters)
	{
		return _object.GetRestInfo(@parameters);
	}
