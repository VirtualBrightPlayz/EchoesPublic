...
public class JoltJoint3D
{
	// Engine object used for calling engine methods
	protected Node3D _object;

	public JoltJoint3D() : this(NativeName)
	{
	}
	protected JoltJoint3D(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected JoltJoint3D(Variant variant) : this((Node3D) variant)
	{
	}
	protected JoltJoint3D([NotNull] Node3D @object)
	{
		_object = @object;
	}

	public static implicit operator Node3D(JoltJoint3D self) => self?._object;
	public static implicit operator Variant(JoltJoint3D self) => self?._object;
	public static explicit operator JoltJoint3D(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	public class PropertyName : Node3D.PropertyName
	{
		...
		public static readonly StringName SolverVelocityIterations = "solver_velocity_iterations";
		public static readonly StringName SolverPositionIterations = "solver_position_iterations";
	}
	...
	public class MethodName : Node3D.MethodName
	{
		...
		public static readonly StringName GetSolverVelocityIterations = "get_solver_velocity_iterations";
		public static readonly StringName SetSolverVelocityIterations = "set_solver_velocity_iterations";
		public static readonly StringName GetSolverPositionIterations = "get_solver_position_iterations";
		public static readonly StringName SetSolverPositionIterations = "set_solver_position_iterations";
	}
	...
	private static readonly StringName NativeName = "JoltJoint3D";

	#region Properties

	public Godot.NodePath NodeA
	{
		get => (Godot.NodePath)_object.Get(PropertyName.NodeA);
		set => _object.Set(PropertyName.NodeA, value);
	}

	public Godot.NodePath NodeB
	{
		get => (Godot.NodePath)_object.Get(PropertyName.NodeB);
		set => _object.Set(PropertyName.NodeB, value);
	}
	...
	{
		get => (bool)_object.Get(PropertyName.ExcludeNodesFromCollision);
		set => _object.Set(PropertyName.ExcludeNodesFromCollision, value);
	}

	public int SolverVelocityIterations
	{
		get => (int)_object.Get(PropertyName.SolverVelocityIterations);
		set => _object.Set(PropertyName.SolverVelocityIterations, value);
	}

	public int SolverPositionIterations
	{
		get => (int)_object.Get(PropertyName.SolverPositionIterations);
		set => _object.Set(PropertyName.SolverPositionIterations, value);
	}
	...
	public Godot.NodePath GetNodeA()
	{
		return (Godot.NodePath)_object.Call(MethodName.GetNodeA);
	}

	public void SetNodeA(Godot.NodePath @path)
	{
		_object.Call(MethodName.SetNodeA, @path);
	}

	public Godot.NodePath GetNodeB()
	{
		return (Godot.NodePath)_object.Call(MethodName.GetNodeB);
	}

	public void SetNodeB(Godot.NodePath @path)
	{
		_object.Call(MethodName.SetNodeB, @path);
	}

	public bool GetExcludeNodesFromCollision()
	{
		return (bool)_object.Call(MethodName.GetExcludeNodesFromCollision);
	}

	public void SetExcludeNodesFromCollision(bool @excluded)
	{
		_object.Call(MethodName.SetExcludeNodesFromCollision, @excluded);
	}

	public int GetSolverVelocityIterations()
	{
		return (int)_object.Call(MethodName.GetSolverVelocityIterations);
	}

	public void SetSolverVelocityIterations(int @iterations)
	{
		_object.Call(MethodName.SetSolverVelocityIterations, @iterations);
	}

	public int GetSolverPositionIterations()
	{
		return (int)_object.Call(MethodName.GetSolverPositionIterations);
	}

	public void SetSolverPositionIterations(int @iterations)
	{
		_object.Call(MethodName.SetSolverPositionIterations, @iterations);
	}
