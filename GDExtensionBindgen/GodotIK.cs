...
public class GodotIK
{
	// Engine object used for calling engine methods
	protected SkeletonModifier3D _object;

	public GodotIK() : this(NativeName)
	{
	}
	protected GodotIK(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected GodotIK(Variant variant) : this((SkeletonModifier3D) variant)
	{
	}
	protected GodotIK([NotNull] SkeletonModifier3D @object)
	{
		_object = @object;
	}

	public static implicit operator SkeletonModifier3D(GodotIK self) => self?._object;
	public static implicit operator Variant(GodotIK self) => self?._object;
	public static explicit operator GodotIK(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : SkeletonModifier3D.PropertyName
	{
		public static readonly StringName IterationCount = "iteration_count";
		public static readonly StringName UseGlobalRotationPoles = "use_global_rotation_poles";
	}

	public class MethodName : SkeletonModifier3D.MethodName
	{
		public static readonly StringName SetIterationCount = "set_iteration_count";
		public static readonly StringName GetIterationCount = "get_iteration_count";
		public static readonly StringName GetBonePosition = "get_bone_position";
		public static readonly StringName SetEffectorTransformsToBones = "set_effector_transforms_to_bones";
		public static readonly StringName SetUseGlobalRotationPoles = "set_use_global_rotation_poles";
		public static readonly StringName GetGlobalRotationPoles = "get_global_rotation_poles";
		public static readonly StringName GetEffectors = "get_effectors";
		public static readonly StringName GetCurrentIteration = "get_current_iteration";
	}

	public class SignalName : SkeletonModifier3D.SignalName
	{

	}

	private static readonly StringName NativeName = "GodotIK";

	#region Properties

	public int IterationCount
	{
		get => (int)_object.Get(PropertyName.IterationCount);
		set => _object.Set(PropertyName.IterationCount, value);
	}

	public bool UseGlobalRotationPoles
	{
		get => (bool)_object.Get(PropertyName.UseGlobalRotationPoles);
		set => _object.Set(PropertyName.UseGlobalRotationPoles, value);
	}
	...
	{
		get => _object.Active;
		set => _object.Active = value;
	}

	public float Influence
	{
		get => _object.Influence;
		set => _object.Influence = value;
	}
	...
	public void SetIterationCount(int @iteration_count)
	{
		_object.Call(MethodName.SetIterationCount, @iteration_count);
	}

	public int GetIterationCount()
	{
		return (int)_object.Call(MethodName.GetIterationCount);
	}

	public Godot.Vector3 GetBonePosition(int @bone_idx)
	{
		return (Godot.Vector3)_object.Call(MethodName.GetBonePosition, @bone_idx);
	}

	public void SetEffectorTransformsToBones()
	{
		_object.Call(MethodName.SetEffectorTransformsToBones);
	}

	public void SetUseGlobalRotationPoles(bool @global_rotation_poles)
	{
		_object.Call(MethodName.SetUseGlobalRotationPoles, @global_rotation_poles);
	}

	public bool GetGlobalRotationPoles()
	{
		return (bool)_object.Call(MethodName.GetGlobalRotationPoles);
	}

	public Godot.Collections.Array<Godot.GodotIKEffector> GetEffectors()
	{
		return (Godot.Collections.Array<Godot.GodotIKEffector>)_object.Call(MethodName.GetEffectors);
	}

	public int GetCurrentIteration()
	{
		return (int)_object.Call(MethodName.GetCurrentIteration);
	}
	...
	{
		_object.SetInfluence(@influence);
	}

	public float GetInfluence()
	{
		return _object.GetInfluence();
	}
	...
	public event Action ModificationProcessedEvent
	{
		add
		{
			Connect(SignalName.ModificationProcessed, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.ModificationProcessed, Callable.From(value));
		}
	}
