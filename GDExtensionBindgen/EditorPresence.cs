...
public class EditorPresence
{
	...
	public EditorPresence() : this(NativeName)
	{
	}
	protected EditorPresence(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected EditorPresence(Variant variant) : this((Node) variant)
	{
	}
	protected EditorPresence([NotNull] Node @object)
	{
		_object = @object;
	}

	public static implicit operator Node(EditorPresence self) => self?._object;
	public static implicit operator Variant(EditorPresence self) => self?._object;
	public static explicit operator EditorPresence(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "EditorPresence";
