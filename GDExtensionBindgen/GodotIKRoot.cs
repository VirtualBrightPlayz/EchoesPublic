...
public class GodotIKRoot
{
	// Engine object used for calling engine methods
	protected Node3D _object;

	public GodotIKRoot() : this(NativeName)
	{
	}
	protected GodotIKRoot(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected GodotIKRoot(Variant variant) : this((Node3D) variant)
	{
	}
	protected GodotIKRoot([NotNull] Node3D @object)
	{
		_object = @object;
	}

	public static implicit operator Node3D(GodotIKRoot self) => self?._object;
	public static implicit operator Variant(GodotIKRoot self) => self?._object;
	public static explicit operator GodotIKRoot(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Node3D.PropertyName
	{
		public static readonly StringName IkController = "ik_controller";
	}

	public class MethodName : Node3D.MethodName
	{
		public static readonly StringName SetIkController = "set_ik_controller";
	...
	private static readonly StringName NativeName = "GodotIKRoot";

	#region Properties

	public Godot.NodePath IkController
	{
		get => (Godot.NodePath)_object.Get(PropertyName.IkController);
		set => _object.Set(PropertyName.IkController, value);
	}
	...
	public void SetIkController(Godot.NodePath @ik_controller)
	{
		_object.Call(MethodName.SetIkController, @ik_controller);
	}

	public Godot.NodePath GetIkController()
	{
		return (Godot.NodePath)_object.Call(MethodName.GetIkController);
	}
