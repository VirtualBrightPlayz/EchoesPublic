...
public class SteamConnection
{
	...
	public SteamConnection() : this(NativeName)
	{
	}
	protected SteamConnection(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected SteamConnection(Variant variant) : this((RefCounted) variant)
	{
	}
	protected SteamConnection([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(SteamConnection self) => self?._object;
	public static implicit operator Variant(SteamConnection self) => self?._object;
	public static explicit operator SteamConnection(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "SteamConnection";
