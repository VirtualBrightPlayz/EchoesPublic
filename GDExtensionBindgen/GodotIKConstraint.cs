...
public class GodotIKConstraint
{
	// Engine object used for calling engine methods
	protected Node _object;

	public GodotIKConstraint() : this(NativeName)
	{
	}
	protected GodotIKConstraint(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected GodotIKConstraint(Variant variant) : this((Node) variant)
	{
	}
	protected GodotIKConstraint([NotNull] Node @object)
	{
		_object = @object;
	}

	public static implicit operator Node(GodotIKConstraint self) => self?._object;
	public static implicit operator Variant(GodotIKConstraint self) => self?._object;
	public static explicit operator GodotIKConstraint(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "GodotIKConstraint";

	#region Enums

	public enum Dir : long
	{
		Backward = -1L,
		Forward = 1L,
	}
