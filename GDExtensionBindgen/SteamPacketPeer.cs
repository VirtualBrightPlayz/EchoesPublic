...
public class SteamPacketPeer
{
	// Engine object used for calling engine methods
	protected RefCounted _object;

	public SteamPacketPeer() : this(NativeName)
	{
	}
	protected SteamPacketPeer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected SteamPacketPeer(Variant variant) : this((RefCounted) variant)
	{
	}
	protected SteamPacketPeer([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(SteamPacketPeer self) => self?._object;
	public static implicit operator Variant(SteamPacketPeer self) => self?._object;
	public static explicit operator SteamPacketPeer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "SteamPacketPeer";
