...
public partial class SpeechRecognizer : Node
{
	...
	private void StartContinuousSpeechRecognition()
	{
		_ = Task.Factory.StartNew(async () =>
		{
			...
			{
				await Task.Delay(TimeSpan.FromSeconds(processInterval).Milliseconds);
				ProcessMicrophone();
