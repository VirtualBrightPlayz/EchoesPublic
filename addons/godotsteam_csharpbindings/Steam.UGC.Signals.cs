...
public static partial class Steam
{
    ...
    public delegate void ItemInstalledEventHandler(uint appId, ulong fileId, ulong legacyContent, ulong manifestId);
    private static event ItemInstalledEventHandler ItemInstalledEvent;
    static Action<uint, ulong, ulong, ulong> _itemInstalledAction = (appId, fileId, legacyContent, manifestId) =>
    {
        ItemInstalledEvent?.Invoke(appId, fileId, legacyContent, manifestId);
    };
